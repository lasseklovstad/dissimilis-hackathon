...
// TODO: unsure if "this" function context is used in testing
...
describe("BottomBar", () => {
    it("Add tone button should be showing on bottombar", function () {
        ...
        const addToneButton = screen.getAllByRole("button", {
            name: /BottomBar:addTone/i,
        })
    ...
    it("Add Bar button should be showing on login page", function () {
        ...
        const addBarButton = screen.getAllByRole("button", {
            name: /BottomBar:addBar/i,
        })
