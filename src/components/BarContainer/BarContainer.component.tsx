...
export const BarContainer: React.FC<BarContainerProps> = (props) => {
    ...
    if (bar === undefined) {
        ...
        let barConst =
            voices[0].bars[props.barNumber - 1].house !== undefined &&
            voices[0].bars[props.barNumber - 1].house !== null
            ...
            <Grid container role="grid" className={classes.fullHeight}>
                <Grid item xs={12}>
                    <Grid
                        ...
                        style={{ height: 'auto' }}
                        role="grid"
                        aria-label="barline before the bar"
                    >
                        <Grid
                            item
                            xs={props.barLineBefore ? 1 : 'auto'}
                            className={classes.barlineBox}
                            style={{
                                height: !props.height ? '160px' : props.height,
                                borderRight: props.barLineBefore
                                    ? '2px solid black'
                                    : '0',
                            }}
                            role="gridcell"
                        ...
                        >
                            <Bar
                                ...
                                barNumber={props.barNumber - 1}
                                height={props.height || 160}
                                repBefore={
                                    voices[0].bars[props.barNumber - 1]
                                        .repBefore
                                }
                                repAfter={
                                    voices[0].bars[props.barNumber - 1].repAfter
                                }
                                house={
                                    voices[0].bars[props.barNumber - 1].house ||
                                    undefined
                                }
                                chordsAndNotes={bar.chordsAndNotes}
                                barLineAfter={props.barLineAfter}
                            />{' '}
                        </Grid>
                    </Grid>
                </Grid>
                <Grid item xs={12} role="row" style={{ height: '32px' }}>
                    <Grid container role="grid">
                        ...
                        <Grid
                            ...
                            role="gridcell"
                            style={{
                                display: props.masterSheet ? 'block' : 'none',
                            }}
                        >
                            <Box display="flex" flexGrow={1}>
                                <Button
                                    ...
                                    onClick={handleClick}
                                    role="button"
                                    aria-label="button to make changes to the bar"
                                >
                                    <MoreHorizIcon
                                ...
                                >
                                    ...
                                    >
                                        {voices[0].bars[props.barNumber - 1]
                                            ...
                                            : t(
                                                  'BarContainer:addRepBefore'
                                              )}{' '}
                                    </MenuItem>
                                    <MenuItem
                                        onClick={() =>
                                            handleClose('toggleRepAfter')
                                        }
                                    >
                                        {voices[0].bars[props.barNumber - 1]
                                            .repAfter
                                            ...
                                            : t(
                                                  'BarContainer:addRepAfter'
                                              )}{' '}
                                    </MenuItem>
                                    <MenuItem
                                        disabled={
                                            props.barNumber - 1 === 0 &&
                                            voices[0].bars.length === 1
                                        }
                                        onClick={() =>
                                            handleClose(
                                                barConst
